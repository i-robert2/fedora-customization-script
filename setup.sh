...
# ---------------------------------------------------------------------------
# 3. Fix CapsLock sticky / delayed toggle-off behavior
# ---------------------------------------------------------------------------
echo "[3/4] Fixing CapsLock sticky behavior..."

# Disable accessibility features that add extra key-processing delays
...
# Lower the keyboard repeat delay (default 500 ms).
# A shorter delay tightens the input pipeline so the CapsLock state change
# is picked up sooner, reducing the "next key is still caps" effect.
gsettings set org.gnome.desktop.peripherals.keyboard delay 250
gsettings set org.gnome.desktop.peripherals.keyboard repeat-interval 30

echo "  Accessibility slow/bounce/sticky keys disabled."
echo "  Keyboard repeat delay reduced to 250 ms (default: 500 ms)."
