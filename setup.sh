...
declare -A MODULE_DESC=(
    ...
    [apps]="Install user apps (Discord, GIMP, Krita, Drawing, darktable, digiKam, Kdenlive, VLC, Chrome, Jellyfin, KVM/QEMU)"
    ...
    [monitoring]="Prometheus + Grafana monitoring for KVM/QEMU VMs (Podman)"
    [ollama]="Install Ollama + AI models (Qwen 2.5 Coder, Qwen 2.5, DeepSeek R1, Phi-4, Gemma 4)"
    ...
    [flashlocal]="Build & install FlashLocal offline flashcard app (Tauri desktop)"
)
